...
function Card({ title, price, bullets, cta, highlight }: { title: string; price: string; bullets: string[]; cta: string; highlight?: boolean }) {
  return (
...
function BoltEmblem({ className = '' }: { className?: string }) {
  return (
